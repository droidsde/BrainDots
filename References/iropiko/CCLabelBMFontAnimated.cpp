...
void CCLabelBMFontAnimated::animateInDropFromTop(float duration, cocos2d::CallFunc *callFuncOnCompletion){
    ...
    runActionOnAllSpritesSequentially(flyInEase, duration, false, callFuncOnCompletion);
